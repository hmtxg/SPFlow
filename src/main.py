if __name__ == '__main__':
    ...
    logging.basicConfig(filename="FLNE.log", level=logging.DEBUG)
    csv_path = "/Users/Hanna/OneDrive/Desktop/SPFlow/src/spn/RSPMN_MDP_Datasets/FrozenLake/FrozenLake.csv"
    ...
    print("2T & IT & TP Obtained, Learning IT to obtain FT")
